...
class AskarElWdooScreen extends StatefulWidget {
  const AskarElWdooScreen({Key? key}) : super(key: key);

  @override
  State<AskarElWdooScreen> createState() => _AskarElWdooScreenState();
}

class _AskarElWdooScreenState extends State<AskarElWdooScreen> {
    ...
    return SafeArea(
        child: Scaffold(          backgroundColor: Colors.teal[50],
          ...
          appBar: AppBar(
            ...
            title: const Text("أذكار الوضوءَ",style: TextStyle(fontWeight: FontWeight.bold),),
            centerTitle: true,
          ),
