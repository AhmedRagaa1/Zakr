...
class AskarElathanScreen extends StatefulWidget {
  const AskarElathanScreen({Key? key}) : super(key: key);

  @override
  State<AskarElathanScreen> createState() => _AskarElathanScreenState();
}

class _AskarElathanScreenState extends State<AskarElathanScreen> {
    ...
    return SafeArea(
        child: Scaffold(          backgroundColor: Colors.teal[50],
          ...
          appBar: AppBar(
            ...
            title: const Text("أذكار عند سماع الآذانَ",style: TextStyle(fontWeight: FontWeight.bold),),
            centerTitle: true,
          ),
