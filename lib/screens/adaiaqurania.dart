...
class AdaiaQuraniaScreen extends StatefulWidget {
  const AdaiaQuraniaScreen({Key? key}) : super(key: key);

  @override
  State<AdaiaQuraniaScreen> createState() => _AdaiaQuraniaScreenState();
}

class _AdaiaQuraniaScreenState extends State<AdaiaQuraniaScreen> {
    ...
    return SafeArea(
        child: Scaffold(          backgroundColor: Colors.teal[50],
          ...
          appBar: AppBar(
            ...
            title: const Text("الْأدْعِيَةُ القرآنيةَ",style: TextStyle(fontWeight: FontWeight.bold),),
            centerTitle: true,
          ),
